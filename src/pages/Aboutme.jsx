...
function Aboutme() {
  return (
    <section
      id="aboutme"
      className="flex min-h-screen flex-row items-center justify-center gap-10 px-20 max-sm:h-auto max-sm:flex-col max-sm:px-20"
    >
      <div className="animate-appear-bottom flex flex-col justify-center transition-all duration-500 ease-in-out xl:w-4/5">
        ...
        <p className="animate-appear-left mt-5 text-balance font-sans text-lg text-gray-800">
